...
public class HealthCheck {
    ...
    public String checkPrometheusUp() {
        ...
        try {
            ...
            if (output.toString().contains("docker-compose-servers/grafana/prometheus") && output.toString().contains("Up")) {
    ...
    public String checkGrafanaUp() {
        ...
        try {
            ...
            if (output.toString().contains("docker-compose-servers/grafana") && output.toString().contains("Up")) {
