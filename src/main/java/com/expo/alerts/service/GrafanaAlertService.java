...
public class GrafanaAlertService {
    ...
    public GrafanaAlertService(RestTemplateBuilder restTemplateBuilder, ObjectMapper objectMapper, GrafanaClient grafanaClient, GrafanaPanel grafanapanel, PanelClient grafanapanel1, AlertCondition alertCondition, ApiKeyUpdater apikeyUpdate) {
